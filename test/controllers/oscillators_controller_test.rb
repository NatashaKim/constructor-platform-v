...
class OscillatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oscillator" do
    assert_difference('Oscillator.count') do
      post oscillators_url, params: { oscillator: { frequency: @oscillator.frequency, integer: @oscillator.integer } }
    end
  ...
  test "should update oscillator" do
    patch oscillator_url(@oscillator), params: { oscillator: { frequency: @oscillator.frequency, integer: @oscillator.integer } }
